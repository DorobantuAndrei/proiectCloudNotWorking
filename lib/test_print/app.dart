...
class MyAppTest extends StatefulWidget {
  const MyAppTest({Key key, this.transactions, this.furnizor})
      : super(key: key);

  final List<MyTransaction> transactions;
  final Furnizor furnizor;
...
class MyAppState extends State<MyAppTest> with SingleTickerProviderStateMixin {
  final int _tab = 0;
